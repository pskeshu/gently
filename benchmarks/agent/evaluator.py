...
class EvalResult:
    ...
    test_id: str
    query: str
    expected_tool: Union[str, List[str]]
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            "tokens": {
                ...
                "avg_per_query": (self.total_input_tokens + self.total_output_tokens) / self.num_cases if self.num_cases > 0 else 0,
            },
            "latency": {
        ...
        try:
            ...
            for key, expected_value in expected_params.items():
                if key == "intent_contains":
                    ...
                    param_errors.append(f"{key}: expected {expected_value}, got {actual_params[key]}")
...
def compare_reports(before: BenchmarkReport, after: BenchmarkReport) -> Dict:
    ...
    return {
        ...
        "regressions": [
            r.test_id for r in after.results
