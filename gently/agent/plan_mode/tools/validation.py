...
def _stage_order(stage_name: str) -> Optional[int]:
    ...
    from gently.organisms.celegans.stages import DevelopmentalStage
    try:
...
async def validate_plan(
    ...
    try:
        from gently.organisms.celegans.detector_presets import get_detector_presets
        valid_detectors = set(get_detector_presets().keys())
    except ImportError:
        valid_detectors = set()
