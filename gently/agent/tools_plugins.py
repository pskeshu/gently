...
def predict_hatching(
    ...
    embryo_id : str, optional
        Single embryo to predict (if not all_embryos)
    all_embryos : bool
        Predict for all embryos with stage classifications
    context : dict
        Execution context
    ...
    if all_embryos:
        ...
        # Add development rate info if available
...
async def assess_image_quality(
    ...
    ----------
    embryo_id : str, optional
        Embryo to assess (uses latest image if available)
    suggest_parameters : bool
        Whether to suggest parameter adjustments
    context : dict
        Execution context
    ...
    # Use Claude Vision for quality assessment
...
SUGGESTIONS: [List specific parameter adjustments if any aspect is POOR]"""
    ...
    try:
        ...
        if suggest_parameters:
            # Parse assessment and suggest parameters
            suggestions = []
...
# =============================================================================
# Session/Experiment Comparison Tools
# =============================================================================
...
# =============================================================================
# Interaction Log Analysis Tools
# =============================================================================
...
def analyze_corrections(
    ...
    for corr in corrections[:limit]:
        ...
        # Count tools that led to corrections
...
def export_interaction_log(
    ...
    ----------
    format : str
        Export format: "summary", "detailed", "jsonl_path"
    context : dict
        Execution context
