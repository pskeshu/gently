...
from ...agent.tool_registry import ToolCategory, ToolParameter
...
def register_ml_tools(registry, context_store=None, gently_store=None,
    ...
    async def inventory_datasets(include_remote: bool = True, **kwargs) -> str:
        from ...data_reasoning.assessment import DataAssessmentEngine
    ...
    async def check_annotation_coverage(session_ids: str = "", **kwargs) -> str:
        from ...data_reasoning.coverage import CoverageAnalyzer
    ...
    async def select_architecture(dataset_size: int, vram_gb: float, **kwargs) -> str:
        from ...ml.architectures import get_suitable_architectures
    ...
    async def start_local_training(pipeline_id: str, **kwargs) -> str:
        ...
        from ...ml.data_loader import build_labels_from_store
        ...
        from ...ml.models import TrainingRun, ModelConfig, TrainingConfig
    ...
    async def plan_annotation_campaign(
        ...
        **kwargs,
        ...
        from ...data_reasoning.coverage import CoverageAnalyzer
        from ...data_reasoning.gap_planner import GapPlanner
