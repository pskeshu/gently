...
class TestToolSelection:
    ...
    def test_plan_mode_only_plan_tools(self, mgr):
        ...
        allowed = {
            ...
            "get_plan_item", "move_plan_item", "delete_plan_item",
            "reorder_plan_items", "update_phase", "delete_phase",
            "export_plan", "query_lab_history", "check_hardware_capability",
            "search_literature", "search_strains", "validate_plan",
...
class TestMemoryCaching:
    ...
    def test_caches_result(self):
        ...
        result2 = mgr.get_cached_memory_awareness()
...
class TestContextDataGathering:
    ...
    def test_with_detections(self):
        ...
        exp = ExperimentState()
        exp.add_embryo("e1")
        exp.embryos["e1"].add_detection_result("comma", {
            "timepoint": 50, "detected": True, "confidence": "HIGH",
