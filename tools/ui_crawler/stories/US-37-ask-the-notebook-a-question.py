...
META = {"id": "US-37", "title": "Ask the notebook a question", "cluster": "12 Notebook", "mode": "agent", "needs_account": False}
...
async def flow(page, url, rec):
    ...
    rec.partial("ask box + Ask button present and accept a question (result panel shows a thinking/answer state); a grounded answer needs a live agent turn (POST /api/notebook/ask → Claude)")
